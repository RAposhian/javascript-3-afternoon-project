...
//Code Here
let myStrongest = monstersInYourPocket.filter((x)=>x.CP > 200 ? x : null)
...
let orderTotals = orders.map((x, y) => x.price * (x.tax + 1), 0)
...
let bobsTotal = purchases.reduce((x, y) => y.owner === 'Bob' ? y.price + x : x, 0)
